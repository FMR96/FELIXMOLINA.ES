...
export const metadata: Metadata = {
  title: "Félix Molina | Consultor Tecnológico, SEO y Automatización IA",
  ...
  authors: [{ name: "Félix Molina", url: "https://felixmolina.es" }],
  creator: "Félix Molina",
  metadataBase: new URL("https://felixmolina.es"),
  alternates: { canonical: "https://felixmolina.es" },
  openGraph: {
    title: "Félix Molina | Consultor Tecnológico, SEO y Automatización IA",
    description: "Félix Molina es consultor tecnológico en Sevilla. SEO técnico, automatización con IA y marketing digital para pymes, restaurantes y emprendedores.",
    ...
    locale: "es_ES",
    type: "website",
    images: [{ url: "/FELIX_MOLINA.JPG", width: 640, height: 640, alt: "Félix Molina — Consultor Tecnológico" }],
  },
  twitter: {
    card: "summary",
    site: "@xfmr96",
    creator: "@xfmr96",
    title: "Félix Molina | Consultor Tecnológico, SEO y Automatización IA",
    description: "Félix Molina es consultor tecnológico en Sevilla. SEO técnico, automatización con IA y marketing digital para pymes y restaurantes.",
  },
  ...
  "@graph": [
    {
      ...
      url: "https://felixmolina.es",
      image: "https://felixmolina.es/FELIX_MOLINA.JPG",
